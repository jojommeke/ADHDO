...
export default function Progress(props) {
  ...
  return (
    <div className="flex w-full justify-center text-center text-3xl text-white portrait:text-2xl">
      <div className="justify-left flex h-auto w-[80%] overflow-clip rounded-lg bg-white bg-opacity-20 text-center backdrop-blur-lg">
        <div
      ...
      <p
        className="text-md mx-10 select-none truncate rounded-lg px-3 py-2 backdrop-blur-md portrait:py-0.5 portrait:text-sm"
